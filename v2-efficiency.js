/* v2-efficiency.js — หน้า Efficiency (ทำได้กี่ % ของเป้า)
   ...
   แต่ตัวเลขทุกค่าคิดใหม่ด้วยสูตร V1 ทั้งหมด
   ...
   ที่ตัดออกจาก V2 เพราะข้อมูลจริงไม่มี (อธิบายไว้ในโน้ตใต้การ์ดบนหน้าเว็บด้วย)
     - โหมดหน่วย ชิ้น/ชม. (unitMode = 'pcs') → ไม่มีจำนวนชิ้นดิบใน Results Master จึงเหลือหน่วย หยิบ/ชม. เดียว
...
(() => {
  ...
  /* ── จัดกลุ่มข้อมูล ──
     ทุกกลุ่มส่งแถวดิบเข้า M.aggregate() ครั้งเดียว จึงได้ sum/count ของกลุ่มตรงตามสูตร V1 */
