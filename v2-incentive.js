    ...
    host.innerHTML = configPanel()
      ...
      + `<div style="display:grid;grid-template-columns:repeat(auto-fit,minmax(420px,1fr));gap:18px;margin:18px 0;">
        ...
        <div class="card wide" style="margin:0;">
          ...
          <div class="sub">สังกัดยึดทะเบียน 2ND ถ้าไม่มีจึงใช้สังกัดใน Results Master ที่พบบ่อยที่สุดของคนนั้น</div>
      ...
      <div class="note v3-notice">
        ...
        ซึ่งต้องใช้จำนวนชิ้นดิบ จำนวนบรรทัด และเวลาเริ่ม-จบระดับนาที — Results Master ไม่มีสามอย่างนี้ จึงคิดเป็น “หน่วยหยิบ” จากยอด Total Pick เท่านั้น
        · ไม่มี blendedTarget จึงใช้ Target ของโซนตามกฎ V1 ตรง ๆ · ไม่มีโซนที่หยิบจริงรายรายการ (โซนในข้อมูลคือโซนสังกัด 1 แถวต่อคนต่อวัน)
